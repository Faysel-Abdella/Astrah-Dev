    ...
    <div className=" w-full  h-fit   ">
      ...
      >
        <div className="w-full relative h-75 flex items-end rounded-[25px] shadow-[inset_0_0px_50px_rgba(255,255,255,0.1)]  bg-card p-5.5 ">
          ...
          <div className=" shadow-[inset_0_0px_50px_rgba(255,255,255,0.05)] bg-white/5 h-35 md:h-30 p-3 w-full  flex flex-col justify-between items-end border rounded-2xl border-white/12 ">
            <div className="flex gap-3 w-full">
              <Plus size={26} className="shrink-0" />
              <p className=" text-muted-foreground ">{placeholder}</p>
            </div>
            <div className="w-fit flex items-end justify-end ">
              <button className=" bg-cyan-600 px-4.5 py-2 rounded-xl shadow-[inset_0_0px_20px_rgba(255,255,255,0.3)]   ">
                <SendHorizonal
                  size={22}
