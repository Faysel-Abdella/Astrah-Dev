...
const PricingCTA = () => {
  return (
    <section className="w-full font-sf-pro ">
      <div className="relative h-86 w-full max-w-175 flex items-center justify-center  mx-auto overflow-hidden">
        ...
        <div className="w-full h-86 bg-linear-to-b bottom-0  absolute from-transparent  to-background"></div>

        <div className="absolute w-full h-full bg-card border rounded-3xl max-w-135 mx-auto flex flex-col p-6 items-center  ">
          <img
            src="/icons/pricing.png"
            alt="Pricing icon"
            className="w-16 h-16 object-cover rounded-3xl"
          />
          <p className=" text-[32px] font-medium mt-8">Transparent pricing.</p>
          <p className="mt-6">
