    ...
    >
      {api?.scrollSnapList().map((_, index) => (
        <button
          ...
          className={cn(
            "h-2.5 w-2.5 transition-all rounded-full border border-primary cursor-pointer",
            index === selectedIndex ? "bg-primary w-4" : "bg-transparent",
          )}
